...
class TransFusionHead(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        if not self.training:
            ...
            # print(f'origin gt_bboxes_3d : {gt_bboxes_3d.size()}')
    ...
    def get_targets_single(self, gt_bboxes_3d, gt_labels_3d, preds_dict):
        ...
        # print(f'pos_assigned_gt_inds : {pos_assigned_gt_inds.size()}')
        # print(f'gt_bboxes_3d : {gt_bboxes_3d.size()}')
        ...
        # print(f'pos_gt_bboxes : {pos_gt_bboxes.size()}')
